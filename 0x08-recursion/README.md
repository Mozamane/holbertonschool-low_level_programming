...
* 2-strlen_recursion - Write a function that returns the length of a string.
...
* 7-is_palindrome - Write a function that returns 1 if a string is a palindrome and 0 if not.


### [8. Inception. Now, before you bother telling me it's impossible...](./100-wildcmp.c)
* 100-wildcmp - Write a function that compares two strings and returns 1 if the strings can be considered identical, otherwise return 0.
